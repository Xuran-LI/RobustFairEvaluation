...
if __name__ == "__main__":
    ...
    cluster_file = "../dataset/credit/test/retrain_avg_clusters.npz.npy"
    BL_model_file = "../dataset/credit/model/BL.h5"
    for cos in [0.70, 0.75, 0.80, 0.85, 0.90, 0.95]:
        for i in range(Retrain_size):
            for m in ["RobustFair"]:
                generate_file = "../dataset/credit/test/Train_{}_{}_10_10.npz.npy".format(m, i)
