...
if __name__ == "__main__":
    ...
    BL_attack_file = "../dataset/compas/result/Result_BL_attack.xlsx"
    ...
    retrain_eval_file = "../dataset/compas/result/Result_retrain_eval.xlsx"
    ...
    seeds_attack_file = "../dataset/compas/result/Result_seeds_attack.xlsx"
    ...
    iter_attack_file = "../dataset/compas/result/Result_iteration_Local.xlsx"
    ...
    iter_attack_file = "../dataset/compas/result/Result_iteration_Global.xlsx"
    workbook_name = xlsxwriter.Workbook(iter_attack_file)
    worksheet = workbook_name.add_worksheet("result Details")
    write_worksheet_2d_data(iter_attack_data, worksheet)
    workbook_name.close()
