...
def retrain_classifier_model(model_file, x_train, y_train, epochs, batch_sizes, model_suffix):
    ...
    file_path = "../dataset/compas/retrain/{}.h5".format(model_suffix)
...
if __name__ == "__main__":
    train_file = "../dataset/compas/data/train.npz.npy"
    cluster_file = "../dataset/compas/test/retrain_avg_clusters.npz.npy"
    BL_model_file = "../dataset/compas/model/BL.h5"
    for cos in [0.70, 0, 75, 0.80, 0.85, 0.90, 0.95]:
        for i in range(Retrain_size):
            for m in ["RobustFair_Max", "RobustFair_Avg", "ADF", "EIDIG", "FGSM", "PGD", "APGD", "ACG"]:
                generate_file = "../dataset/compas/test/Train_{}_{}_10_10.npz.npy".format(m, i)
