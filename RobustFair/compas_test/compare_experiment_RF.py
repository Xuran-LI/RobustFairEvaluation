...
V_files = ["../dataset/compas/model/V_0.h5", "../dataset/compas/model/V_1.h5", "../dataset/compas/model/V_2.h5"]
C_num = 4
S_num = 200
D_tag = "compas"
P_attr = [0, 1, 2]
...
if __name__ == "__main__":
    ...
    D_file1 = "../dataset/compas/test/BL_{}_RF_generation.npz.npy"
    files1 = [D_file1.format(n) for n in range(len(M_names))]
    D_file2 = "../dataset/compas/test/BL_{}_RF_generation_similar.npz.npy"
    files2 = [D_file2.format(n) for n in range(len(M_names))]
    R_file = "../dataset/compas/result/BL_RF_generation_result.xlsx"
