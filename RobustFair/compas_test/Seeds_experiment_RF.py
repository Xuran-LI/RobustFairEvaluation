...
if __name__ == "__main__":
    for S_num in seeds_num:
        ...
        D_file1 = "../dataset/compas/test/Seeds_" + str(S_num) + "_BL_{}_RF_generation.npz.npy"
        files1 = [D_file1.format(n) for n in range(len(M_names))]
        D_file2 = "../dataset/compas/test/Seeds_" + str(S_num) + "_BL_{}_RF_generation_similar.npz.npy"
        files2 = [D_file2.format(n) for n in range(len(M_names))]
        R_file = "../dataset/compas/result/Seeds_" + str(S_num) + "_BL_RF_generation_result.xlsx"
