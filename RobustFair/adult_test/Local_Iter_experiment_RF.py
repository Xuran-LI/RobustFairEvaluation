...
if __name__ == "__main__":
    for S_t2 in local_iterations:
        ...
        D_file1 = "../dataset/adult/test/Iterations_" + str(S_t2) + "_BL_{}_RF_generation.npz.npy"
        files1 = [D_file1.format(n) for n in range(len(M_names))]
        D_file2 = "../dataset/adult/test/Iterations_" + str(S_t2) + "_BL_{}_RF_generation_similar.npz.npy"
        files2 = [D_file2.format(n) for n in range(len(M_names))]
        R_file = "../dataset/adult/result/Iterations_" + str(S_t2) + "_BL_RF_generation_result.xlsx"
